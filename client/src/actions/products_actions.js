...
export function getProductsByArrival() {
  //?sortBy=createdAt&order=desc&limit=100
  const request = axios
...
export function getProductsToShop(
  ...
  const request = axios
    ...
    .then((response) => {
      // if we have previous state, attach that as well with the next 6 products
...
// Clear the product name from redux on form success
